...
@section('title','Admin | Edit Brand Content')
                ...
                <div class="card-body">
                    <form action="/brand/{{ $brand->id }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mt-2">
                            ...
                            <input type="file" oninput="pic.src=window.URL.createObjectURL(this.files[0])" id="bi" class="form-control" name="brand_image">
                            <img id="pic" height="100" width="100" src="{{ asset('uploads/brands/'.$brand->brand_image) }}" alt="">
                        </div>
                        <div class="mt-2">
